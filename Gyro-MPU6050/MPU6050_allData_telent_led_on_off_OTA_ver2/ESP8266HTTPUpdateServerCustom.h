...
#define __HTTP_UPDATE_SERVER_CUSTOM_H
...
class ESP8266HTTPUpdateServerCustomTemplate
{
  public:
    ESP8266HTTPUpdateServerCustomTemplate(bool serial_debug=false);
...
#include "ESP8266HTTPUpdateServerCustom-impl.h"


using ESP8266HTTPUpdateServerCustom = esp8266httpupdateservercustom::ESP8266HTTPUpdateServerCustomTemplate<WiFiServer>;

namespace BearSSL {
using ESP8266HTTPUpdateServerSecure = esp8266httpupdateservercustom::ESP8266HTTPUpdateServerCustomTemplate<WiFiServerSecure>;
};
